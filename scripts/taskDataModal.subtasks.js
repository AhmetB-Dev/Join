...
function createSubtaskActions() {
  ...
  const editIcon = createActionIcon("../assets/img/board/pen.png", "Edit", "subtask-edit-edit");
  const deleteIcon = createActionIcon("../assets/img/board/trash.png", "Delete", "subtask-delete-edit");
